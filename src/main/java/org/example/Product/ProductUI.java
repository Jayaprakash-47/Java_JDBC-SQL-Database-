    ...
    static void main() {
        ...
        switch(choice) {
            ...
            case 2:
                ...
                dao.add(new Product(pname, brand, category, price, rating, discount));
            ...
            case 5:
                System.out.print("Enter product id: ");
                int fid = sc.nextInt();
                Product product = dao.findById(fid);
            ...
            case 6:
                ...
                dao.updatePriceById(upid, nprice);
                System.out.println("Price updated successfully");
                break;
            case 7:
                System.out.print("Enter brand: ");
                String fbrand = sc.next();
                List<Product> brandList = dao.filterByBrand(fbrand);
            ...
            case 8:
                System.out.print("Enter category: ");
                String fcat = sc.next();
                List<Product> catList = dao.filterByCategory(fcat);
            ...
            case 9:
                ...
                List<Product> priceList = dao.filterByPriceRange(min, max);
            ...
            case 10:
                ...
                List<Product> ratingList = dao.filterByRating(frating);
                for(Product p : ratingList) {
                    System.out.println(p);
                }
                break;
            case 11:
                List<Product> ascList = dao.sortByPriceAsc();
                for(Product p : ascList) {
                    System.out.println(p);
                }
                break;
            case 12:
                List<Product> descList = dao.sortByPriceDesc();
            ...
            case 14:
                ...
                break;
            case 15:
                Product expensive = dao.findMostExpensive();
                System.out.println(expensive);
                break;
            case 16:
                Product cheapest = dao.findCheapest();
                System.out.println(cheapest);
                break;
            case 17:
                System.out.print("Enter keyword: ");
                String keyword = sc.next();
                List<Product> searchList = dao.searchByName(keyword);
